...
## T-Test
###by cluster 
t.test(trap_results_final_cluster_2$cluster_ovi, trap_results_final_cluster_2$cluster_bg, paired = T) 

### by cluster and time point
t.test(trap_results_final_3$ovitrap, trap_results_final_3$bg, paired = T) 
